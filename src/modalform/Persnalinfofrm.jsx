...
import "../style/modalform/pernalinfo.scss";

import MultiSelect from "react-multi-select-component";
export const Persnalinfofrm = () => {
  ...
  return (
    ...
    <Form.Control type="email" placeholder="Type your district here" />
  </Form.Group>

  <Form.Group controlId="formGroupEmail"  className="mt-3">
    <Form.Label className="lbl_a">Home Location </Form.Label>
    <Form.Control type="" placeholder="Type your district here" />
  </Form.Group>
       

  <Form.Group controlId="formGroupEmail"  className="mt-3">
    <Form.Label className="lbl_a"> Preferred Work Location </Form.Label>
